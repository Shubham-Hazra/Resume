...
\begin{itemize}[itemsep = -0.65 mm, leftmargin=*]
    ...
    \item Implemented \textbf{multiple layers}, including query expansion, intent classifier, and validator to \textbf{mitigate hallucination} and improve the responses of the chatbot. Stored conversation history using \textbf{SQLite} for maintaining session state.
