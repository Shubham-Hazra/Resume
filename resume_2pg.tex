...
\end{itemize}
\vspace{-20pt}
\noindent\section*{{\color{black!20!blue}\LARGE Work Experience\xfilll[0pt]{0.5pt}}}
\vspace{-10pt}
...
\vspace{\baselineskip}
\vspace{-15pt}
\noindent\textbf{\large Blockchain Simulator}\hfill{\sl \small (Summer 2023)}\\
{\it Self Project}
\\\vspace{-15pt}
\begin{itemize}[itemsep = -0.65 mm, leftmargin=*]
    \item Used \textbf{Pygame} and \textbf{OpenAI's Gym} to train a lunar lander game \textbf{Deep Q-Learning with Experience Replay}. Used the \textbf{Sequential API} of the Keras library to define the \textbf{Q-network} and the \textbf{target Q-network}
...
\end{itemize}
\vspace{-20pt}
\noindent\section*{\color{black!20!blue}\LARGE Other Projects\xfilll[0pt]{0.5pt}}
% \pagebreak
\vspace{\baselineskip}
\vspace{-20pt}
...
\noindent\section*{\color{black!20!blue}\LARGE Key Courses Undertaken\xfilll[0pt]{0.5pt}}
\vspace{-8pt}
