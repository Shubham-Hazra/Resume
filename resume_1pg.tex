...
\\\vspace{-17pt}
\begin{itemize}[itemsep = -1.4 mm, leftmargin=*]
    \item Developed and implemented each component of a \textbf{Latent Diffusion} model using \textbf{PyTorch}, including a Variational Autoencoder (VAE), \textbf{Diffusion U-Net} with timestep embeddings and self-attention, and various scheduling techniques
