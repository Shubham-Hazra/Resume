...
\begin{itemize}[itemsep = -0.65 mm, leftmargin=*]
    ...
    \item Utilized \textbf{Haystack} framework and \textbf{FAISS} to efficiently index and store proprietary data, leveraging \textbf{vectorDBs} to store the embeddings. Utilized \textbf{Hugging Face models} to form the entire \textbf{indexing and retrieval pipeline} 
    \item Included \textbf{document reranking} resulting in improved relevance and accuracy of the retrieved information for chatbot 
