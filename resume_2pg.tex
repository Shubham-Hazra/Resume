...
\vspace{-2pt}
\begin{itemize}[itemsep = -0.65 mm, leftmargin=*]
    \item Used \textbf{MATLAB} with a data set of images of various fruits and generated new
          representative fruit images using \textbf{Principal Component Analysis (PCA)} and optimally \textbf{reduce the
